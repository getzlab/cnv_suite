...
from cnv_suite.utils.common_build_dicts import HG19_CSIZE, HG19_CENT_LOC, HG38_CSIZE, HG38_CENT_LOC
...
class CNV_Profile:
    ...
    def __init__(self, num_subclones=3, csize=None, ref_build="hg19", cent_loc=None):
        ...
        if not csize:
            if ref_build == "hg19":
                csize = HG19_CSIZE
                if cent_loc is None:
                    cent_loc = HG19_CENT_LOC
            elif ref_build == "hg38":
                csize = HG38_CSIZE
                if cent_loc is None:
                    cent_loc = HG38_CENT_LOC
            else:
    ...
    def generate_coverage(self, purity, cov_binned, x_coverage=None, sigma=None, do_parallel=True):
        ...
        return self.compute_coverage(x_coverage_df, purity, x_coverage=x_coverage, sigma=sigma, do_parallel=do_parallel)
